...
class RGBSnowman:
    ...
    def fade_colour(self, old_colour: tuple, new_colour: tuple):
        ...
        r_diff = (old_colour[0] - new_colour[0]) / slice_time
        g_diff = (old_colour[1] - new_colour[1]) / slice_time
        b_diff = (old_colour[2] - new_colour[2]) / slice_time
        for i in range(start=0, stop=1000, step=1):
